...
- [x] GitHub Pages 링크로 배포 및 접속 확인 (설치 없이 브라우저 플레이) — 2026-07-28: PR #10(develop→main, 62커밋) 머지, Pages를 GitHub Actions 소스로 API 활성화 후 `deploy-pages` 재실행 성공. `https://baeyounghwan.github.io/NAN2026/` 접속해 오프닝 컷신 정상 렌더 확인
